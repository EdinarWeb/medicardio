...
$action='ajax';
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and socio like '%$q%' or dni like '%$q%' or nombre like '%$q%'";
		...
		if ($numrows>0){
			...
			<div class="table-responsive ">
			  <table class="table table-hover" style="border-color: #2F3947;">
				<tr style="color: #fff; background-color: #2F3947; border-color: #2F3947;">
					<!--<th>Foto</th>-->
						<th>ID</th>
						<th>Nombre</th>
						<th>Correo</th>
