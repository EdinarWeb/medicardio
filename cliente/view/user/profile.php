...
<html>
    ...
    <!-- Sweet Alert: alertas JavaScript presentables para el usuario (mรฝs bonitas que el alert) -->
	...
	<body>
		<div class="page">
        	...
        	<nav class="navtop">			
			<div><h1> CARNET <span class="medicardio">&nbsp;<strong> MEDICARDIO</strong></span>&nbsp; &nbsp;<i class="far fa-address-card"></i></h1></div>				
       	 </nav>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
                    <img src="img/MEDICARDIO.jpg" alt="imagen medicardio" width="300" height="300">
                </div>
        
			<div class="table col-lg-4 col-lg-offset-4"> 
			<table>
								<?php
								  $id=$_SESSION['id'];
					...
					<tr>
						...
						<div class="plan-medicardio col-lg-12">
							<p class="text-center color  well well-small"><strong><?php echo $mostrar['plan1'];?></strong></p>
						</div>
						<br>

						<td><?php echo $mostrar['socio'];?></td>
					</tr>
					<tr>
						<td><strong>Afiliado:</strong></td>
						<td><?php echo $mostrar['afiliado'];?></td>
					</tr>
					<tr>
				...
				<div class="plan">
					<p class="text-center color text-top"><strong><?php echo $mostrar['plan2'];?></strong></p>
				</div>
				<?php
					}
					?>
				<p class="text-center text"><strong>Atenci&oacute;n al Socio: 4847-8200</strong></p>
				<hr class="hr">
				<p class="text-center text"><strong>Informaci&oacute;n al Viajero: 0800-777-0114</strong></p>
				<p class="text-center text-2"><strong>(Fuera de Capital Federal y Conurbano Bonaerense)</strong></p>
			</div>
		</div>
		</div>
	</div>
